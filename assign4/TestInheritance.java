...
class TestInheritance{
	...
	basic = input.nextInt();
	input.nextLine();
	arr[0] = new Employee(name,address,empid,dept,basic);
	...
	arr[1] = new Faculty(name,address,empid,dept,basic,desig,course);
	...
	arr[2]= new ResearchAssistant(name,address,empid,dept,basic,project,course,marks);
