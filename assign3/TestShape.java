...
class TestShape{
	public static void main(String[] args){
		...
		for(int i = 0 ; i < 3 ; i++){
			switch(i){
				case 0 :System.out.println("i)Default constructor Circle():");				break;
				case 1: System.out.println("ii)1 parameter constructor Circle(radius)");		break;
				case 2: System.out.println("iii)2 parameter constructor Circle(radius,color)");	break;
			}
		...
		for(int i = 0 ; i < 3 ; i++){
			switch(i){
				case 0 :System.out.println("i)Default constructor Rectangle():");						break;
				case 1: System.out.println("ii)2 parameter constructor Rectangle(width,length)");		break;
				case 2: System.out.println("iii)3 parameter constructor Rectangle(width,length,color)");	break;
			}
		...
		for(int i = 0 ; i < 3 ; i++){
				switch(i){
				case 0 :System.out.println("i)Default constructor Sqaure():");				break;
				case 1: System.out.println("ii)1 parameter constructor Sqaure(side)");			break;
				case 2: System.out.println("iii)2 parameter constructor Sqaure(side,color)");	break;
			}
